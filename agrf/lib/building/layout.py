...
for x in [5431, 5441, 5448, 5452, 5454, 5456, 5459, 5475, 5476, 5478, 5479, 5484, 5485, 5486, 991, 992, 995, 999, 1000, 1001]:
    DEFAULT_GRAPHICS[x] = BuildingCylindrical.create_variants([DefaultGraphics(x, yofs=-8)])
for x in [5464, 5473, 5477, 990, 993, 994, 997, 998, 999, 1002]:
